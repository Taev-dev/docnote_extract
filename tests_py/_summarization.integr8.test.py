...
class TestSummarization:
    ...
    def test_summarization_with_finnr_money(self):
        ...
        assert isinstance(summary, ModuleDesc)
        assert isinstance(summary.metadata, DescMetadata)
        ...
        assert isinstance(money_summary, ClassDesc)
        ...
        assert isinstance(rtm_summary, CallableDesc)
    ...
    def test_summarization_with_finnr_currency(self):
        ...
        assert isinstance(currency_summary, ClassDesc)
        ...
        code_alpha3_summary = currency_summary / GetattrTraversal(
            'code_alpha3')
        assert isinstance(code_alpha3_summary, VariableDesc)
